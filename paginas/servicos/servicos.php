...
<?php
    ...
    if ($totalPagina > 1) {
        ...
        if ($pagina > 1) {
          echo '<li class="page-item"><a class="page-link" href="?menuop=servicos&pagina=' . $paginaAnterior . '"> < </a></li>';
        }
        ...
        if ($pagina < $totalPagina) {
          echo '<li class="page-item"><a class="page-link" href="?menuop=servicos&pagina=' . $paginaSeguinte . '"> > </a></li>';
        }
